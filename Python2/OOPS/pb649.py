...
# Values are stored into a NumPy array. After converting the following numpy array into Celsius, then sort the array and
...
import numpy as np
farenh=np.array([0, 12, 45.21, 34, 99.91, 32])
celc=(farenh*5/9)-(5*32/9)
print(celc)
x1=np.sort(celc)
print(x1)

x2=np.where(x1==0.0)  #Index print karse
print(x2)
